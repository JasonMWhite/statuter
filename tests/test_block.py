...
class TestPage(object):
    ...
    def test_add_word(self):
        w1 = Word()
        w2 = Word()
        page = Page(1, 0.0, 300.0, 0.0, 305.0)
        page.add_word(w1)
        page.add_word(w2)
...
class TestLine(object):
    ...
    def test_can_add(self, line):
        ...
        fourth_word = Word()
        fourth_word.add_character(Character(1.9, 2.0, 10.6, 11.6, size=5.2, font='Arial', text='z'))
    ...
    def test_add_word(self, line):
        ...
        fourth_word = Word()
        fourth_word.add_character(Character(2.0, 2.1, 10.6, 11.6, size=5.2, font='Arial', text='z'))
